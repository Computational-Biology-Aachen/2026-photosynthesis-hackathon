		...
		<div class="row">
			...
			<div>
				...
				<Text color="white">
					...
					differential equations. He is currently working on his PhD in Biology
					at Heinrich-Heine University Düsseldorf. Marvin recreationally
					develops web applications. In addition, he has national and
					international teaching experience, having taught introductory courses
					in mathematical modeling, computation and systems biology.
				</Text>
			</div>
		</div>
	</Section>
